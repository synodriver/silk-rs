...
pub fn decode_silk(src: impl AsRef<[u8]>, sample_rate: i32, frame_size: i32, frames_per_packet: i32, more_internal_decoder_frames: bool, in_band_fec_offset: i32, loss: bool) -> Result<Vec<u8>, SilkError> {
    unsafe { _decode_silk(src.as_ref(),sample_rate, frame_size, frames_per_packet, more_internal_decoder_frames, in_band_fec_offset, loss) }
}

unsafe fn _decode_silk(mut src: &[u8],  sample_rate: i32, frame_size: i32, frames_per_packet: i32, more_internal_decoder_frames: bool, in_band_fec_offset: i32, loss: bool) -> Result<Vec<u8>, SilkError> {
    // skip tencent flag
