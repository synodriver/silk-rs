...
pub fn encode_silk(
    ...
    unsafe { _encode_silk(src.as_ref(), sample_rate, bit_rate, max_internal_sample_rate, packet_loss_percentage, complexity, use_inband_fec, use_dtx, tencent) }
}
...
unsafe fn _encode_silk(
    ...
    let enc_control = sdk::SKP_SILK_SDK_EncControlStruct {
        ...
        complexity,// 2  [0,1,2]
        useInBandFEC: use_inband_fec as i32, // 0
        useDTX: use_dtx as i32, // 0
    };
